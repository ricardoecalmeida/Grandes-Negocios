...
public class FuncionarioView {
    ...
    public static void menuFuncionario() throws IOException {
        ...
        FuncionarioController funcionarioController = new FuncionarioController("src/test/resources/minmercadoTest.csv");
        ...
        do {
            ...
            switch (opcao) {
                case 1:
                    ...
                    funcionarioController.addVenda(tipoProduto,nomeProduto,quantidadeProduto,precoProduto,"src/test/resources/minmercadoTest.csv");
                    break;
